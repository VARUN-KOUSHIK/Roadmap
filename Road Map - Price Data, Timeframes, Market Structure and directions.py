...
class PriceDataEngine:
    ...
    def fetch_ohlcv(self, symbol_token, timeframe):
        lookback = {"1 Minute":1, "3 Minute":2, "5 Minute":5, "15 Minute":10, "30 Minute":20, "1 Hour":30, "4 Hour":60, "Daily":365, "Weekly":730}
...
st.title("🇮🇳 Indian Market Roadmap Dashboard")
...
symbols = {
    ...
    "SENSEX": 265, "MIDCAP NIFTY": 288009, "RELIANCE": 738561, "HDFC BANK": 341249
}

sym = st.sidebar.selectbox("Symbol", list(symbols.keys()))
tf = st.sidebar.selectbox("Timeframe", ["1 Minute", "3 Minute", "5 Minute", "15 Minute", "1 Hour", "Daily"])
...
if st.sidebar.button("Run Analysis"):
    ...
    if df is not None:
        ...
        state = "BULLISH" if score >= 2 else "SIDEWAYS/BEARISH"
        
        st.metric("Market State", state, f"Score: {score}")
